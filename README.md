...
- **SEAMUNs Dashboard**: [thedashboard.seamun.com](https://thedashboard.seamun.com) — for use during conferences; chairs and delegates can track activity and documents
...
See **[docs/vercel.md](docs/vercel.md)** for step-by-step setup (GitHub import, environment variables, Firebase authorized domains, custom domain).
