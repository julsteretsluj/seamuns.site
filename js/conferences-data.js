...
},
{
    ...
    name: "SEAMUN I",
    organization: "SEAMUN",
    location: "AIT (Asian Institute of Technology) Conference Center, Pathum Thani, Thailand",
    countryCode: "TH",
    startDate: "2027-01-28",
    endDate: "2027-01-29",
    description: "SEAMUN I — Policies with a Purpose. Two-day conference at AIT Conference Center featuring 10 committees including UNHRC, DISEC, UN Women, UNEP, Press Corps, WHO, UNSC, UNODC, ECOSOC, and the Fantasy World Committee (FWC). 200 delegates, 22 chairs, 8 SMT, 10 staff, 10 external advisors (250 total).",
    website: "",
    registrationDeadline: "",
    positionPaperDeadline: "",
    status: "upcoming",
