...
},
{
    ...
    name: "SEAMUN I 2027",
    organization: "SEAMUN",
    location: "Venue TBD (Thailand)",
    countryCode: "TH",
    startDate: "2027-01-23",
    endDate: "2027-01-24",
    description: "SEAMUN I 2027 — Policies with a Purpose. Two-day conference featuring 15 committees across UN bodies, regional institutions, specialized media/education, and crisis/historical formats. 200 delegates, 22 chairs, 8 SMT, 10 staff, 10 external advisors (250 total).",
    ...
    committees: [
        ...
        "UN Women (United Nations Entity for Gender Equality and the Empowerment of Women) - The Question of Affirming and Guaranteeing Women's Reproductive Autonomy by Establishing International Legal Standards on Access to Safe and Legal Abortion | The Question of Examining the Recognition of Universal Childcare as a Fundamental Human Right and Its Role in Addressing Declining Birth Rates and Supporting Gender Equality in the Workforce",
    ...
    availableAwards: ["Best Delegate", "Outstanding Delegate", "Honorable Mention", "Best Position Paper", "Best Chair"],
    previousWinners: [],
    schedule: "<p><strong>23–24 January 2027:</strong> Two-day conference — Opening Ceremony, Committee Sessions, Closing Ceremony.</p>",
    venueGuide: "<p>Venue to be confirmed.</p>",
    extraNotes: "<p style=\"margin: 0 0 1rem 0; padding: 10px 14px; background: rgba(255, 193, 7, 0.15); border-left: 4px solid var(--accent-orange, #ff9800); border-radius: 6px; font-size: 0.95em;\"><strong>Planning phase:</strong> This conference is still in the planning phase. All information is subject to change.</p><p><strong>Grades:</strong> Conference open to grades 7–12 (approximately ages 12–18). Some committees have topic-based grade limits; see each committee below.</p><p><strong>SEAMUN I 2027 — Policies with a Purpose.</strong> Two-day conference. <strong>Fees:</strong> School delegate 2,500 THB; Independent delegate 3,000 THB; Chair 800 THB. <strong>Capacity:</strong> 200 delegates, 22 chairs, 8 SMT, 10 staff, 10 external advisors (250 total). Secretary General: Jules (juleskittoastrop@gmail.com). General enquiries: info@seamuns.site. Follow us on Instagram: <a href='https://www.instagram.com/seamun.th.conference/' target='_blank' rel='noopener noreferrer'>@seamun.th.conference</a>. <strong>Accessibility:</strong> Wheelchair accessible and sensory-friendly. FWC universe and allocations: fill in the <a href='https://forms.gle/UjSBFFS6Y2oAcogPA' target='_blank' rel='noopener noreferrer'>FWC Topic &amp; Allocations Preference Form</a>. SMT applications: <a href='https://forms.gle/dKEGKJmLbT86YHqU9' target='_blank' rel='noopener noreferrer'>SMT Application Form</a>.</p>"
},
{
    id: 9,
    name: "HEXAMUN '26",
