...
},
{
    ...
    endDate: "2027-01-29",
    description: "SEAMUN I 2027 — Policies with a Purpose. Two-day conference at MDCU featuring 10 committees including UNHRC, DISEC, UN Women, UNEP, Press Corps, WHO, UNSC, UNODC, ECOSOC, and the Fantasy World Committee (FWC). 200 delegates, 22 chairs, 8 SMT, 10 staff, 10 external advisors (250 total).",
    ...
    committees: [
        ...
        "UNEP (United Nations Environmental Program) - The Question of Combating Rising Temperatures in the Arctic and Preventing Ocean Acidification | The Question of Protecting Sensitive Island Ecosystems from Invasive Species and Recovering Ecosystems That Were Damaged",
        "Press Corps - The Question of Determining the Circumstances in Which Journalists Can and Should Report on Public Affairs | The Question of Combating Political Influence on and Censorship of Media and Journalism",
        "WHO (World Health Organization) - The Question of Examining the Ethical and Regulatory Landscape for the Clinical Use of Psychedelic Drugs in the Treatment of Trauma-Based Mental Health Conditions | The Question of Examining Measures to Safeguard Patient Autonomy, Uphold Professional Integrity, Prioritize Personal and Cultural Factors, and Ensure the Protection of Human Rights in the Context of Euthanasia and Assisted Suicide",
        "UNSC (United Nations Security Council) - The Question of Addressing the Role of Education and Information Management in Preventing Youth Radicalization and Extremism | The Question of Developing and Standardizing Best Practices for Peacekeeping Operations to Ensure Scalable and Sustainable Global Implementation",
        "UNODC (United Nations Office on Drugs and Crime) - The Question of Policy Analysis of Alternatives to Conviction and Punishment for Drug Possession for Personal Use | The Question of Mitigating Environmental Degradation and Ecosystem Damage Resulting from Illicit Drug Cultivation and Production",
        "ECOSOC (Economic and Social Council) - The Question of Implementing a Globally Coordinated Universal Basic Income (UBI) Programme as a Strategy for Poverty Eradication and Economic Stability | The Question of Exploring International Mechanisms for Reallocating Military Expenditures Towards the Development and Strengthening of Global Public Health Systems",
        "FWC (Fantasy World Committee) - Topics TBD. <a href='https://forms.gle/UjSBFFS6Y2oAcogPA' target='_blank' rel='noopener noreferrer'>Fill in the FWC Topic &amp; Allocations Preference Form</a> to rank your preferred universe and allocations."
    ],
    uniqueTopics: [
        "Death Penalty Abolition and Right to Life",
        "Prison Administration and Degrading Treatment",
        "WMD Cross-Border Transport",
        "Conventional Arms Diversion",
        "Women's Reproductive Autonomy",
        "Universal Childcare and Gender Equality",
        "Arctic Temperatures and Ocean Acidification",
        ...
        "Youth Radicalization and Extremism",
        "Peacekeeping Best Practices",
        "Alternatives to Drug Conviction",
        "Illicit Drug Cultivation and Environment",
