...
const I18N_TRANSLATIONS = {
    th: {
        ...
        'Sign Up': 'สมัครสมาชิก',
        'Logout': 'ออกจากระบบ',
        'Back to conferences': 'กลับไปที่การประชุม',
        'Track upcoming and previous Model United Nations conferences across South East Asia 🌏': 'ติดตามการประชุม MUN ทั้งที่กำลังจะมาถึงและที่ผ่านมาในเอเชียตะวันออกเฉียงใต้ 🌏',
        'Conferences': 'การประชุม',
        'Upcoming & Previous MUNs': 'การประชุมที่กำลังจะมาถึงและที่ผ่านมา',
        'Prospective MUNs': 'การประชุมที่อยู่ระหว่างพิจารณา',
        'How to Host an MUN': 'วิธีจัด MUN',
        'Schools & Advisors': 'โรงเรียนและที่ปรึกษา',
        'Participating Schools': 'โรงเรียนที่เข้าร่วม',
        'How to Become a Participating School': 'วิธีเป็นโรงเรียนที่เข้าร่วม',
        'Advisor Guide': 'คู่มือที่ปรึกษา',
        'Delegates & Chairs': 'ผู้แทนและประธาน',
        'How to Sign Up (Delegate Guide)': 'วิธีสมัคร (คู่มือผู้แทน)',
        'Individual Delegates': 'ผู้แทนอิสระ',
        'Chair Guide': 'คู่มือประธาน',
        'Chair Superlatives': 'รางวัลประธาน',
        'MUN Guide': 'คู่มือ MUN',
        'How to Prep': 'วิธีเตรียมตัว',
        'How to Stand Out': 'วิธีโดดเด่น',
        'Confidence Building': 'การสร้างความมั่นใจ',
        'Support at Conferences': 'การสนับสนุนในงานประชุม',
        'Resources': 'แหล่งข้อมูล',
        'Points & Motions': 'ข้อเสนอและมติต่างๆ',
        'Committees': 'คณะกรรมการ',
        'Traditional Committees': 'คณะกรรมการทั่วไป',
        'Special Committees': 'คณะกรรมการพิเศษ',
        'Conduct': 'มารยาท',
        'Speeches': 'สุนทรพจน์',
        'Resolutions': 'มติ',
        'Crisis': 'วิกฤต',
        'Position Papers': 'เอกสารท่าที',
        'Awards': 'รางวัล',
        'General Assembly': 'สมัชชาใหญ่',
        'Examples': 'ตัวอย่าง',
        'Templates': 'เทมเพลต',
        ...
        'Position Paper': 'เอกสารท่าที',
        'Conference intro & aims': 'แนะนำการประชุมและเป้าหมาย',
        'Secretariat': 'ฝ่ายเลขาฯ',
        'Sign Up & Accessibility': 'สมัครและการเข้าถึง',
        'Independent delegates': 'ผู้แทนอิสระ',
        'Advisor signup': 'สมัครที่ปรึกษา',
        'Accessibility': 'การเข้าถึง',
        'Committees': 'คณะกรรมการ',
        'Unique topics': 'หัวข้อพิเศษ',
        'Chairs & pages': 'ประธานและเพจ',
        'SMT roles & qualities': 'บทบาทและคุณสมบัติ SMT',
        'Forms': 'แบบฟอร์ม',
        'Allocations': 'การจัดสรร',
        'Awards': 'รางวัล',
        'Available awards': 'รางวัลที่มี',
        'Previous winners': 'ผู้ชนะที่ผ่านมา',
        'Schedule': 'กำหนดการ',
        'Venue guide': 'คู่มือสถานที่',
        'Extra notes': 'หมายเหตุเพิ่มเติม',
        'See more': 'ดูเพิ่มเติม',
        'Mark as Attending': 'ทำเครื่องหมายว่าจะเข้าร่วม',
        'Sign Up as Independent Delegate': 'สมัครเป็นผู้แทนอิสระ',
        'Sign Up Your School': 'สมัครโรงเรียนของคุณ',
        'Delegate Estimate:': 'ประมาณการผู้แทน:',
        'Sensory friendly: Yes': 'รองรับความไวต่อประสาทสัมผัส: ใช่',
        'Sensory friendly: No': 'รองรับความไวต่อประสาทสัมผัส: ไม่',
        'Wheelchair friendly': 'รองรับรถเข็น',
        'Wheelchair: contact organisers': 'รถเข็น: ติดต่อผู้จัดงาน',
        'Conference Dates': 'วันที่การประชุม',
        'Registration Deadline': 'กำหนดลงทะเบียน'
    },
    zh: {
        'Language': '语言',
        'Theme': '主题',
        ...
        'Sign Up': '注册',
        'Logout': '退出登录',
        'Back to conferences': '返回会议',
        'Track upcoming and previous Model United Nations conferences across South East Asia 🌏': '追踪东南亚即将举行和过往的模联会议 🌏',
        'Conferences': '会议',
        'Upcoming & Previous MUNs': '即将举行与过往会议',
        'Prospective MUNs': '筹备中的会议',
        'How to Host an MUN': '如何举办模联',
        'Schools & Advisors': '学校与指导老师',
        'Participating Schools': '参与学校',
        'How to Become a Participating School': '如何成为参与学校',
        'Advisor Guide': '指导老师指南',
        'Delegates & Chairs': '代表与主席',
        'How to Sign Up (Delegate Guide)': '如何报名（代表指南）',
        'Individual Delegates': '个人代表',
        'Chair Guide': '主席指南',
        'Chair Superlatives': '主席奖项',
        'MUN Guide': '模联指南',
        'How to Prep': '如何准备',
        'How to Stand Out': '如何脱颖而出',
        'Confidence Building': '自信提升',
        'Support at Conferences': '会议支持',
        'Resources': '资源',
        'Points & Motions': '动议与程序',
        'Committees': '委员会',
        'Traditional Committees': '传统委员会',
        'Special Committees': '特别委员会',
        'Conduct': '行为规范',
        'Speeches': '发言',
        'Resolutions': '决议',
        'Crisis': '危机',
        'Position Papers': '立场文件',
        'Awards': '奖项',
        'General Assembly': '大会',
        'Examples': '示例',
        'Templates': '模板',
        ...
        'Registration': '报名',
        'Position Paper': '立场文件',
        'Conference intro & aims': '会议简介与目标',
        'Secretariat': '秘书处',
        'Sign Up & Accessibility': '报名与无障碍',
        'Independent delegates': '个人代表',
        'Advisor signup': '指导老师报名',
        'Accessibility': '无障碍',
        'Unique topics': '特色议题',
        'Chairs & pages': '主席与引导员',
        'SMT roles & qualities': 'SMT 职务与要求',
        'Forms': '表格',
        'Allocations': '分配',
        'Available awards': '可获得奖项',
        'Previous winners': '往届获奖者',
        'Schedule': '日程',
        'Venue guide': '场地指南',
        'Extra notes': '附加说明',
        'See more': '查看更多',
        'Mark as Attending': '标记为将参加',
        'Sign Up as Independent Delegate': '个人代表报名',
        'Sign Up Your School': '学校报名',
        'Delegate Estimate:': '预计代表人数：',
        'Sensory friendly: Yes': '感官友好：是',
        'Sensory friendly: No': '感官友好：否',
        'Wheelchair friendly': '轮椅可进入',
        'Wheelchair: contact organisers': '轮椅：请联系主办方',
    ...
    ja: {
        ...
        'Sign Up': '登録',
        'Logout': 'ログアウト',
        'Back to conferences': '会議一覧へ戻る',
        'Track upcoming and previous Model United Nations conferences across South East Asia 🌏': '東南アジアの開催予定・過去のMUN会議を追跡します 🌏',
        'Conferences': '会議',
        'Upcoming & Previous MUNs': '開催予定・過去の会議',
        'Prospective MUNs': '企画中の会議',
        'How to Host an MUN': 'MUNの開催方法',
        'Schools & Advisors': '学校とアドバイザー',
        'Participating Schools': '参加校',
        'How to Become a Participating School': '参加校になる方法',
        'Advisor Guide': 'アドバイザーガイド',
        'Delegates & Chairs': '代表と議長',
        'How to Sign Up (Delegate Guide)': '参加方法（代表ガイド）',
        'Individual Delegates': '個人代表',
        'Chair Guide': '議長ガイド',
        'Chair Superlatives': '議長表彰',
        'MUN Guide': 'MUNガイド',
        'How to Prep': '準備方法',
        'How to Stand Out': '目立つ方法',
        'Confidence Building': '自信向上',
        'Support at Conferences': '会議サポート',
        'Resources': 'リソース',
        'Points & Motions': '動議とポイント',
        'Committees': '委員会',
        'Traditional Committees': '通常委員会',
        'Special Committees': '特別委員会',
        'Conduct': '行動規範',
        'Speeches': 'スピーチ',
        'Resolutions': '決議',
        'Crisis': 'クライシス',
        'Position Papers': 'ポジションペーパー',
        'Awards': '表彰',
        'General Assembly': '総会',
        'Examples': '例',
        'Templates': 'テンプレート',
        ...
        'Conference intro & aims': '会議の概要と目的',
        'Secretariat': '事務局',
        'Sign Up & Accessibility': '登録とアクセシビリティ',
        'Independent delegates': '個人代表',
        'Advisor signup': 'アドバイザー登録',
        'Accessibility': 'アクセシビリティ',
        'Unique topics': '特別議題',
        'Chairs & pages': '議長とページ',
        'SMT roles & qualities': 'SMTの役割と要件',
        'Forms': 'フォーム',
        'Allocations': '割り当て',
        'Available awards': '表彰内容',
        'Previous winners': '過去の受賞者',
        'Schedule': 'スケジュール',
        'Venue guide': '会場案内',
        'Extra notes': '追加情報',
        'See more': 'もっと見る',
        'Mark as Attending': '参加予定にする',
        'Sign Up as Independent Delegate': '個人代表として登録',
        'Sign Up Your School': '学校登録',
        'Delegate Estimate:': '代表見込み：',
        'Sensory friendly: Yes': '感覚配慮：あり',
        'Sensory friendly: No': '感覚配慮：なし',
        'Wheelchair friendly': '車椅子対応',
        'Wheelchair: contact organisers': '車椅子：主催者に連絡',
        'Conference Dates': '会議日程',
    ...
    ru: {
        ...
        'Sign Up': 'Регистрация',
        'Logout': 'Выйти',
        'Back to conferences': 'Назад к конференциям',
        'Track upcoming and previous Model United Nations conferences across South East Asia 🌏': 'Отслеживайте предстоящие и прошедшие конференции MUN в Юго‑Восточной Азии 🌏',
        'Conferences': 'Конференции',
        'Upcoming & Previous MUNs': 'Предстоящие и прошедшие',
        'Prospective MUNs': 'Планируемые конференции',
        'How to Host an MUN': 'Как провести MUN',
        'Schools & Advisors': 'Школы и наставники',
        'Participating Schools': 'Участвующие школы',
        'How to Become a Participating School': 'Как стать участвующей школой',
        'Advisor Guide': 'Гайд для наставников',
        'Delegates & Chairs': 'Делегаты и председатели',
        'How to Sign Up (Delegate Guide)': 'Как зарегистрироваться (гид делегата)',
        'Individual Delegates': 'Индивидуальные делегаты',
        'Chair Guide': 'Гайд председателя',
        'Chair Superlatives': 'Награды председателей',
        'MUN Guide': 'Гайд MUN',
        'How to Prep': 'Как подготовиться',
        'How to Stand Out': 'Как выделиться',
        'Confidence Building': 'Уверенность',
        'Support at Conferences': 'Поддержка на конференциях',
        'Resources': 'Ресурсы',
        'Points & Motions': 'Пункты и процедуры',
        'Committees': 'Комитеты',
        'Traditional Committees': 'Традиционные комитеты',
        'Special Committees': 'Спецкомитеты',
        'Conduct': 'Поведение',
        'Speeches': 'Речи',
        ...
        'Conference intro & aims': 'Описание и цели конференции',
        'Secretariat': 'Секретариат',
        'Sign Up & Accessibility': 'Регистрация и доступность',
        'Independent delegates': 'Индивидуальные делегаты',
        'Advisor signup': 'Регистрация наставника',
        'Accessibility': 'Доступность',
        'Unique topics': 'Уникальные темы',
        'Chairs & pages': 'Председатели и пейджи',
        'SMT roles & qualities': 'Роли и требования SMT',
        'Forms': 'Формы',
        'Allocations': 'Распределения',
        'Available awards': 'Доступные награды',
        'Previous winners': 'Прошлые победители',
        'Schedule': 'Расписание',
        'Venue guide': 'Гид по месту проведения',
        'Extra notes': 'Дополнительные заметки',
        'See more': 'Показать еще',
        'Mark as Attending': 'Отметить как участника',
        'Sign Up as Independent Delegate': 'Зарегистрироваться как индивидуальный делегат',
        'Sign Up Your School': 'Зарегистрировать школу',
        'Delegate Estimate:': 'Оценка делегатов:',
        'Sensory friendly: Yes': 'Сенсорная доступность: Да',
        'Sensory friendly: No': 'Сенсорная доступность: Нет',
        'Wheelchair friendly': 'Доступно для колясок',
        'Wheelchair: contact organisers': 'Коляска: свяжитесь с организаторами',
        'Conference Dates': 'Даты конференции',
    ...
    fr: {
        ...
        'Sign Up': 'Inscription',
        'Logout': 'Déconnexion',
        'Back to conferences': 'Retour aux conférences',
        'Track upcoming and previous Model United Nations conferences across South East Asia 🌏': 'Suivez les conférences MUN à venir et passées en Asie du Sud‑Est 🌏',
        'Conferences': 'Conférences',
        'Upcoming & Previous MUNs': 'Conférences à venir et passées',
        'Prospective MUNs': 'Conférences envisagées',
        'How to Host an MUN': 'Comment organiser un MUN',
        'Schools & Advisors': 'Écoles et conseillers',
        'Participating Schools': 'Écoles participantes',
        'How to Become a Participating School': 'Devenir une école participante',
        'Advisor Guide': 'Guide des conseillers',
        'Delegates & Chairs': 'Délégués et présidences',
        'How to Sign Up (Delegate Guide)': 'Comment s’inscrire (guide des délégués)',
        'Individual Delegates': 'Délégués individuels',
        'Chair Guide': 'Guide des présidences',
        'Chair Superlatives': 'Distinctions de présidence',
        'MUN Guide': 'Guide MUN',
        'How to Prep': 'Comment se préparer',
        'How to Stand Out': 'Comment se démarquer',
        'Confidence Building': 'Renforcer la confiance',
        'Support at Conferences': 'Soutien lors des conférences',
        'Resources': 'Ressources',
        'Points & Motions': 'Points et motions',
        'Committees': 'Comités',
        'Traditional Committees': 'Comités traditionnels',
        'Special Committees': 'Comités spéciaux',
        'Conduct': 'Conduite',
        'Speeches': 'Discours',
        'Resolutions': 'Résolutions',
        'Crisis': 'Crise',
        'Position Papers': 'Documents de position',
        'Awards': 'Récompenses',
        ...
        'Conference intro & aims': 'Présentation et objectifs',
        'Secretariat': 'Secrétariat',
        'Sign Up & Accessibility': 'Inscription et accessibilité',
        'Independent delegates': 'Délégués individuels',
        'Advisor signup': 'Inscription conseiller',
        'Accessibility': 'Accessibilité',
        'Unique topics': 'Sujets uniques',
        'Chairs & pages': 'Présidences et pages',
        'SMT roles & qualities': 'Rôles et qualités SMT',
        'Forms': 'Formulaires',
        'Allocations': 'Allocations',
        'Available awards': 'Récompenses disponibles',
        'Previous winners': 'Anciens lauréats',
        'Schedule': 'Programme',
        'Venue guide': 'Guide du lieu',
        'Extra notes': 'Notes supplémentaires',
        'See more': 'Voir plus',
        'Mark as Attending': 'Marquer comme participant',
        'Sign Up as Independent Delegate': 'S’inscrire comme délégué individuel',
        'Sign Up Your School': 'Inscrire votre école',
        'Delegate Estimate:': 'Estimation des délégués :',
        'Sensory friendly: Yes': 'Adapté aux sensibilités : Oui',
        'Sensory friendly: No': 'Adapté aux sensibilités : Non',
        'Wheelchair friendly': 'Accessible en fauteuil',
        'Wheelchair: contact organisers': 'Fauteuil : contactez les organisateurs',
        'Conference Dates': 'Dates de la conférence',
    ...
    es: {
        ...
        'Back to conferences': 'Volver a conferencias',
        'Track upcoming and previous Model United Nations conferences across South East Asia 🌏': 'Sigue las conferencias MUN próximas y pasadas en el sudeste asiático 🌏',
        'Conferences': 'Conferencias',
        'Upcoming & Previous MUNs': 'Conferencias próximas y pasadas',
        'Prospective MUNs': 'Conferencias previstas',
        'How to Host an MUN': 'Cómo organizar un MUN',
        'Schools & Advisors': 'Escuelas y asesores',
        'Participating Schools': 'Escuelas participantes',
        'How to Become a Participating School': 'Cómo convertirse en escuela participante',
        'Advisor Guide': 'Guía de asesores',
        'Delegates & Chairs': 'Delegados y presidencias',
        'How to Sign Up (Delegate Guide)': 'Cómo inscribirse (guía del delegado)',
        'Individual Delegates': 'Delegados individuales',
        'Chair Guide': 'Guía de presidencia',
        'Chair Superlatives': 'Distinciones de presidencia',
        'MUN Guide': 'Guía MUN',
        'How to Prep': 'Cómo prepararse',
        'How to Stand Out': 'Cómo destacar',
        'Confidence Building': 'Construir confianza',
        'Support at Conferences': 'Apoyo en conferencias',
        'Resources': 'Recursos',
        'Points & Motions': 'Puntos y mociones',
        'Committees': 'Comités',
        'Traditional Committees': 'Comités tradicionales',
        'Special Committees': 'Comités especiales',
        'Conduct': 'Conducta',
        'Speeches': 'Discursos',
        'Resolutions': 'Resoluciones',
        'Crisis': 'Crisis',
        'Position Papers': 'Documentos de posición',
        'Awards': 'Premios',
        ...
        'Conference intro & aims': 'Introducción y objetivos',
        'Secretariat': 'Secretaría',
        'Sign Up & Accessibility': 'Registro y accesibilidad',
        'Independent delegates': 'Delegados individuales',
        'Advisor signup': 'Registro de asesor',
        'Accessibility': 'Accesibilidad',
        'Unique topics': 'Temas únicos',
        'Chairs & pages': 'Presidencias y pages',
        'SMT roles & qualities': 'Roles y cualidades de SMT',
        'Forms': 'Formularios',
        'Allocations': 'Asignaciones',
        'Available awards': 'Premios disponibles',
        'Previous winners': 'Ganadores anteriores',
        'Schedule': 'Horario',
        'Venue guide': 'Guía del lugar',
        'Extra notes': 'Notas adicionales',
        'See more': 'Ver más',
        'Mark as Attending': 'Marcar como asistente',
        'Sign Up as Independent Delegate': 'Registrarse como delegado individual',
        'Sign Up Your School': 'Registrar tu escuela',
        'Delegate Estimate:': 'Estimación de delegados:',
        'Sensory friendly: Yes': 'Apto sensorialmente: Sí',
        'Sensory friendly: No': 'Apto sensorialmente: No',
        'Wheelchair friendly': 'Accesible en silla de ruedas',
        'Wheelchair: contact organisers': 'Silla de ruedas: contactar a organizadores',
        'Conference Dates': 'Fechas de la conferencia',
...
function applyTranslations(lang) {
    ...
    nodes.forEach(node => {
        const original = I18N_ORIGINAL_TEXT.has(node) ? I18N_ORIGINAL_TEXT.get(node) : node.nodeValue;
        if (!I18N_ORIGINAL_TEXT.has(node)) {
            I18N_ORIGINAL_TEXT.set(node, original);
        }
        let text = original;
