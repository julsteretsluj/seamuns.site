-- SEAMUNs – one-shot database setup
-- Creates the database and all tables + sample data.
-- Run once (e.g. mysql -u root -p < scripts/setup-database.sql)
-- Or: mysql -u root -p -e "source scripts/setup-database.sql"

CREATE DATABASE IF NOT EXISTS seamuns_db
...
-- ============================================
-- SAMPLE DATA – MUN07 IV (insert only if empty)
-- ============================================
INSERT IGNORE INTO conferences (
    conference_id, name, organization, location, country_code,
    start_date, end_date, description, website,
    registration_deadline, position_paper_deadline, status, size,
    general_email, mun_account, advisor_account, sec_gen_accounts, parliamentarian_accounts,
    price_per_delegate, independent_dels_welcome, independent_signup_link, advisor_signup_link,
    disabled_suitable, sensory_suitable, schedule, venue_guide, extra_notes
) VALUES (
    1, 'MUN07 IV', 'St Andrews International School, Sukhumvit 107', 'Bangkok, Thailand', 'TH',
    ...
    'https://mun07.org', '2026-02-07', '2026-02-14', 'upcoming', '250+ attendees',
    'mun07sta@gmail.com', '@mun07', 'mun07sta@gmail.com',
    'PJ (@janekij_) and Poon (@natthawit._)', 'Contact via mun07sta@gmail.com',
    '900 THB', TRUE, 'https://forms.gle/cwyjPqszetrQGaNN8', 'https://forms.gle/xKSp8oSejzXDE6gV7',
    TRUE, TRUE,
...
INSERT IGNORE INTO committees (conference_id, name, topic, chair_info) VALUES
...
INSERT IGNORE INTO unique_topics (conference_id, topic) VALUES
(1, 'Human Rights Abuses'), (1, 'Taiwan Strait Conflict'), (1, 'Space Weaponization'),
(1, 'Yemen Political Transition'), (1, 'Drone Warfare'), (1, 'National Guard Policing'),
(1, 'Human Trafficking'), (1, 'Ecuador v. Mexico Dispute'), (1, 'Thailand-Cambodia Conflict'),
(1, 'Fake News & Disinformation');

INSERT IGNORE INTO allocations (conference_id, country) VALUES
(1, 'Thailand'), (1, 'Singapore'), (1, 'Malaysia'), (1, 'Vietnam'), (1, 'Indonesia'),
(1, 'Philippines'), (1, 'Brunei'), (1, 'Myanmar'), (1, 'Cambodia'), (1, 'Laos');

INSERT IGNORE INTO available_awards (conference_id, award_name) VALUES
(1, 'Best Delegate'), (1, 'Outstanding Delegate'), (1, 'Honorable Mention'),
(1, 'Best Position Paper'), (1, 'Best Chair');
